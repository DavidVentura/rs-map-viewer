...
// Resolved when the encounter loads (see assets/encounterAnimations.ts). Its slams, stances and
// phantom attacks double as the director's slam cadence, stance pauses and phantom windups, so the
// director times the fight off the very sequences the Warden and its phantoms play.
